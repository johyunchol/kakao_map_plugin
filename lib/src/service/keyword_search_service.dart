...
///
/// 카카오 로컬 API의 키워드 검색 기능을 제공합니다.
/// 싱글톤 패턴으로 구현되어 있으며, [Completer] 기반의 비동기 처리를 사용합니다.
///
/// 사용 예시:
/// ```dart
/// final response = await controller.keywordSearch(
...
class KeywordSearchService extends BaseService<KeywordSearchResponse> {
  ...
  /// [KeywordSearchService]의 싱글톤 인스턴스를 반환합니다.
  ...
  /// 네이티브 플랫폼에서 키워드 검색 결과를 받아 처리하는 콜백입니다.
  ///
  ...
  ///
  /// 네이티브 플랫폼에서 검색이 완료되면 [KeywordSearchResponse]를 반환합니다.
  /// 이 Future는 [keywordSearchCallback]이 호출될 때 완료됩니다.
