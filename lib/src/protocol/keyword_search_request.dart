...
/// 키워드 검색 요청 클래스입니다.
///
/// 카카오 로컬 API의 키워드 검색을 위한 요청 파라미터를 정의합니다.
/// 장소명, 지번 주소, 도로명 주소 검색이 가능합니다.
///
/// 예시:
/// ```dart
/// final request = KeywordSearchRequest(
///   keyword: '카카오프렌즈',
...
class KeywordSearchRequest {
  /// 검색할 키워드입니다. (필수)
  ///
  /// 검색어는 공백 포함 최대 100자까지 가능합니다.
  /// 장소명, 지번 주소, 도로명 주소를 검색할 수 있습니다.
  final String keyword;

  /// 키워드 필터링을 위한 카테고리 그룹 코드입니다. (선택)
  ///
  /// 특정 카테고리의 장소만 검색하고 싶을 때 사용합니다.
  /// 예: MT1(대형마트), CS2(편의점), PS3(어린이집) 등
  ...
  /// KeywordSearchRequest 생성자입니다.
  ///
  /// [keyword]는 필수 파라미터이며, 나머지는 선택 파라미터입니다.
